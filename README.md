# One click install/ run scripts for windows 98
...
3. Download my scripts [stable](https://github.com/MrDiagnose/Windows98-install-scripts-DosBox-X/releases/download/v1.0.3/win98_dosBox-x_script_v1.0.3.zip)(stable) or [unstabl](ehttps://github.com/MrDiagnose/Windows98-install-scripts-DosBox-X/releases/download/v1.0.3/win98_dosBox-x_script_v1.0.3.unstable.zip)(unstable uses core=dynamic_x86 which is much master than normal but the dosbox-x crashes) and extract it where dosbox-x.exe is located
