...
3. Download my [scripts](https://github.com/MrDiagnose/Windows98-install-scripts-DosBox-X/releases/download/v1.0.1/win98_dosBox-x_script_v1.0.1.zip) and extract it where dosbox-x.exe is located
